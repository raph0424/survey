...
$resultu = $unControleur->selectuser();
$results = $unControleur->selectInscrireid();
if(isset($_POST["sinscrir"]))
      {
		  $envois = array ("text"=>$_POST['text'],
         "Date"=>date("Y-m-d H:i:s")
		 );
		 $unControleur->insert("message",$envois);
...
<div>
  <?php 
      ...
      require_once("affichage/vueUserInscrit.php");
  ?>
</div>
<footer id="footer">
...
<a href="#" class="back-to-top"><i class="fa fa-angl