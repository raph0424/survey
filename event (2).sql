...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 14 Juin 2019 à 20:59
...
(4, 'Julie', 1, 'm', 2, 1),
(12, 'RaphaÃ«l', 4, 'Test', 4, 2),
(13, 'RaphaÃ«l', 4, 'Test', 4, 1);
...
(4, 'S9', 500, 9, 9, 'noir', '2019-06-25', 1),
(5, 'S9Blue', 500, 19, 10, 'Bleu', '2019-05-24', 1),
(6, 'S8', 500, 25, 25, 'Rose', '2019-05-24', 1),
(7, 'S6', 200, 10, 10, 'vert', '2019-10-20', 1);
...
--
ALTER TABLE `produit`
  MODIFY `id_telephone` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
